...
import 'package:water_sampler/ControllingPage.dart';
...
class BotolNiskinPage extends StatefulWidget {
  const BotolNiskinPage({Key? key}) : super(key: key);

  @override
  State<BotolNiskinPage> createState() => _BotolNiskinPageState();
}

class _BotolNiskinPageState extends State<BotolNiskinPage> {
            ...
            return (value.device == null
                ...
                : Column(
                    children: [
                      ...
                      ControllingPage(server: value.device),
                    ],
                  ));
          }),
        ),
